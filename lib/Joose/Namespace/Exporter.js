...
Joose.Module("Joose.Namespace.Exporter", function (m) {
	...
	**/
	isValueInArray = Joose.A.exists;


	m.handleModule = function (classdef, importList) {
	...
	if (typeof JSAN !== "undefined") {
		...
		JSAN.observers.push(function (packageName, packageValue, importList) {
			...
			if (importList) {
				m.handleModule(packageValue, importList);
			}
